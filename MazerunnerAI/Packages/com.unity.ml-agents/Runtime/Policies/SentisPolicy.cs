...
namespace Unity.MLAgents.Policies
{
    ...
    public enum InferenceDevice
    {
        ...
        /// <summary>
        /// GPU inference with the Compute Shader backend. Corresponds to WorkerFactory.Type.ComputeShader in InferenceEngine.
        /// </summary>
        ComputeShader = 1,

        /// <summary>
        /// CPU inference using Burst. Corresponds to WorkerFactory.Type.CSharpBurst in InferenceEngine.
        /// </summary>
        Burst = 2,

        /// <summary>
        /// GPU inference with the Pixel Shader backend. Corresponds to in WorkerFactory.Type.PixelShader InferenceEngine.
